...
export function VideoCutterPlayer({
  selectedVideo,
  userName,
  apiBaseUrl,
  onDownload,
  ...
  return (
    ...
    >
      <ToggleSwitch isOn={useTrim} onToggle={() => setUseTrim(!useTrim)} />
      <video
        ref={videoRef}
        muted
        key={selectedVideo}
          ...
          >
            {hasTrimRange && (
              <button
                ...
                onClick={() =>
                  onDownload(selectedVideo, { startTime, endTime })
                }
              >
                Download
              </button>
